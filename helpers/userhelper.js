  ...
  signupinsertion: (userdata) => {
    return new Promise((resolve, reject) => {
      ...
      const mailOptions = {
        ...
        text: `Please click on the following link to verify your email address:https://sparowwpurchase.site/verify?token=${token}&name=${name}&email=${email}&password=${password}&mobile=${mobile}`,
      };
